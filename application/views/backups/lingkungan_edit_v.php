...
<div class="section-body">
    <h2 class="section-title">Ubah Data Lingkungan</h2>
    <p class="section-lead">Halaman untuk ubah data lingkungan</p>
    <div class="row">
        <div class="col-md-8">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0">Form Ubah Lingkungan</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-body">
                            <div class="form-group"id="frm_kodewil" >
                                ...
                                <select class="form-control select2" id="kodewil" name="kodewil" required>
                                    ...
                                    <option  <?= ($data->kode_wilayah == $d->kode_wilayah)?'selected':''; ?>   value="<?= $d->kode_wilayah.':'.$d->wilayah ?>">[<?= $d->kode_wilayah; ?>] <?= $d->wilayah ?> </option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kode_lingkungan" name="kode_lingkungan" placeholder="Masukkan Kode Lingkungan" required="required" value="<?= $data->kode_lingkungan?>">
                            </div>
                            <div class="form-group">
                                <label for="lingkungan" >Lingkungan</label>
                                <input type="text" class="form-control" id="lingkungan" name="lingkungan" placeholder="Masukkan Nama Lingkungan" required="required" style="text-transform:uppercase" value="<?= $data->lingkungan?>">
                            </div>                                
                        </div>
