...
<div class="section-body">
    <h2 class="section-title">Tambah Data Umat</h2>
    <p class="section-lead">Halaman untuk tambah data umat</p>
    <div class="row">
        <div class="col-md-8">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0">Form Tambah Data Umat </h4>
                </div>
                <div class="card-body">
                    <form method="post" class="form-material" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Umat" required="required" style="text-transform:uppercase" >
                            </div>                                
                        </div>
