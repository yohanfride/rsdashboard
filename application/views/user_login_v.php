    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 bg-white">
          <div class="p-4 m-3">
            <img src="<?= base_url()?>assets/img/logo.png" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
            <h4 class="text-dark font-weight-normal">Welcome to  <span class="font-weight-bold">Dashboard</span></h4>
            <p class="text-muted">Hospital Management Information System with Blockhain </p>
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url()?>assets/img/example-bg.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-5">
              <div class="mb-2 pb-3">
                <h1 class="mb-2  font-weight-bold">Rumah Sakit Islam Jemursari</h1>
                <h5 class="font-weight-normal text-muted-transparent">Surabaya, Indonesia</h5>
              </div>
              Sumber <a class="text-light bb" target="_blank" href="https://rsisjs.id/">rsisjs.id</a>
            </div>
          </div>
        </div>
      </div>
